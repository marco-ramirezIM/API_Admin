...
import exceptions
from src.companies.schemas import CompanyBase, CompanyCreate, CompanyUpdate
from config.db import Session
from typing import List
import dependencies as dp

companyRouter = APIRouter(tags=["Compañia"])
...
@companyRouter.put("/companies/{company_id}", response_model=CompanyBase)
...
@companyRouter.post("/companies", response_model=CompanyBase)
